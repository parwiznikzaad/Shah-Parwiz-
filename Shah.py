...
os.system('pkg install curl')
	...
	logo = (""""\033[132m🅁①🄵④🅃
__ MMMMMMMb. 68b MM Mb Y89 MM MM _ _  __ _ _ _ ___ MM MM 6MMMMb MM 6MM MM( ,M. )M' MM MMMMMMMMP MM .M9 8M' Mb MM69 " Mb dMb d' MM / dMP MMMMMMM9' ,oMM MM' YM. ,PYM. ,P MM dMP MM ,6MM9'MM MM Mb d'Mb d' MM dMP MM MM' MM MM YM,P YM,P MM dMP MM MM. ,MM MM MM' MM' MM dMP / _MM_ YMMM9'Yb_MM_ YP YP _MM_dMMMMMMMM\033[1;37m\n""")
def ud():
    os.system('clear')
    jalan(logo)
    print(' \033[1;32m[1] SUBSCRIBE MY TIKTOK)
    print(' [2] EXIT')
...
def o():
    ...
    jalan(' \x1b[1;32m[3] \x1b[1;32mSUBSCRIBE MY TIK TOK')
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('.https://www.facebook.com/profile.php?id=100076211978824', {
